                  ...
                  <div className="flex items-center justify-between p-6 bg-white/[0.02] border border-white/5 rounded-2xl group hover:border-white/10 transition-all">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/40">
                          {whatsappStatus === 'ready' ? 'Conectado e pronto para mensagens' : 
          ...
          <div className="relative bg-[#0e0e0e] border border-white/10 p-8 rounded-3xl max-w-sm w-full text-center space-y-6 shadow-2xl">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-white/40 leading-relaxed">
                Abra o WhatsApp no seu celular, vá em Aparelhos Conectados e escaneie este código para autenticar.
              </p>
            </div>

            {whatsappStatus === 'ready' && (
              <div className="bg-emerald-500/10 text-emerald-500 py-3 rounded-xl text-xs font-bold uppercase tracking-widest">
